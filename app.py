...
class AnalyzeTextRunnable(Runnable):
    def invoke(self, input: QuestionRequest):
...
analyze_text_runnable = AnalyzeTextRunnable()
add_routes(fastapi_app, analyze_text_runnable, path="/analyze_langserve")
